-- Manual MySQL repair/init script for the knowledge-management tables.
-- docs/user.sql is separate and owns the shared user table.
-- Normal application startup should use Flyway migrations in km-backend/src/main/resources/db/migration.
-- Use this script only for local repair/manual initialization when Flyway V1 was skipped.
